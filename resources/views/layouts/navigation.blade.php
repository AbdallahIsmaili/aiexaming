    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                ...
                @if((Request::is('dashboard') or Request::is('subject') or Request::is('exam')) and Auth::user()->rank === 'admin')
                ...
                @if((Request::is('dashboard') or Request::is('subject') or Request::is('exam')) and Auth::user()->rank === 'teacher')
